...
use WPbuilder\models\custom\Contact;

class ContactCategory extends Taxonomy
{
  const TYPE = 'contact_category';

  public static function register()
  {
    register_taxonomy(self::TYPE, Contact::TYPE, array(
      'hierarchical' => true,
  ...
  {
    $default = array(
      __('Cutomer', 'wpbuilder'),
      __('Supplier', 'wpbuilder'),
      __('Partner', 'wpbuilder'),
      __('Other', 'wpbuilder'),
    );
